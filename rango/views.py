...
from rango.models import Category # imports categ. model
...
def register(request):
	#Boolean value which says whether reg. was successful. Initially false
	#Changes when reg is successful
...
def visitor_cookie_handler(request):
	...
	# above gets no. of visits to site.
	#COOKIES.get() obtains visits cookie
	#If cookie doesnt exist, def value of 1 is used.
